...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$error) {
        ...
        $uniqueSlug = ensureUniqueSlug('team_members', $slug);
        ...
        $memberId = insertRecord('team_members', $data);
        
        if ($memberId) {
            $_SESSION['alert'] = ['type' => 'success', 'message' => 'Team member added successfully!'];
                ...
                <div class="card-compact">
                    ...
                    <div class="card-body-compact">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="position" class="form-control" placeholder="e.g. Executive Director, Program Manager..." required value="<?php echo htmlspecialchars($_POST['position'] ?? ''); ?>">
                        </div>
                        
                        <div class="form-group mb-3">
                            <label class="form-label">Biography</label>
                            <textarea name="bio" class="form-control" rows="5" placeholder="Brief introduction about this team member..."><?php echo htmlspecialchars($_POST['bio'] ?? ''); ?></textarea>
                        </div>
                        
                        <div class="form-row">
                            <div class="form-group col-6 mb-3">
                                <label class="form-label">Email</label>
                                <input type="email" name="email" class="form-control" placeholder="email@example.com" value="<?php echo htmlspecialchars($_POST['email'] ?? ''); ?>">
                            </div>
                            <div class="form-group col-6 mb-3">
                                <label class="form-label">Phone</label>
                                <input type="text" name="phone" class="form-control" placeholder="+256 700 000000" value="<?php echo htmlspecialchars($_POST['phone'] ?? ''); ?>">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-compact">
                    ...
                    <div class="card-body-compact">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <small class="form-text">JPG, PNG, GIF, WebP</small>
                        </div>
